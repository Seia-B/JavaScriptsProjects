...
function placeXorO(squareNumber) {
    ...
    //The .some() method is used to checck each element of the selectSquare array
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("Images/circle-ring.png")';
        }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.strokeStyle = 'rgba(7, 19, 251, 0.8)';
